...
public class MainScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_Activity = findViewById(R.id.editTextTextMultiLine);
        tv_Activity.setClickable(false);
        tv_Activity.setFocusable(false);
        tv_Activity.setFocusableInTouchMode(false);
        tv_Activity.setLongClickable(false);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    tv_Activity.setText(activityresult);
                }
    ...
    public void LoadAnotherActivityFAB(View view){
        ...
        requestQueue = Volley.newRequestQueue(this);
        if (tv_Activity.getText().toString().equals("Your Activity Will be Generated Here!"))
            LoadURL(randomurl);
        else
            LoadURL(url);
    }
    ...
    public void AddedToFavourites(View view){
        ...
        database.favouritesDao().AddFavourite(key, tv_Activity.getText().toString());
